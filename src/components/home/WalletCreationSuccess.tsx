...
const EXTENSION_ID = "egpnoiomgnehopjhhlebenghjcialbbh"
        ...
        <div className='w-full h-full flex flex-col justify-between p-2 gap-4'>
            <div className='w-full flex flex-col items-center justify-center gap-4 text-center flex-grow'>
                <div className='w-full flex flex-col gap-2 justify-center items-center'>
                    ...
                    <div className='text-secondary/80 max-w-xs tracking-wide  text-base flex items-center justify-center gap-1'>
                        {isSynced
